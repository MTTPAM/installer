...
from direct.particles import ParticleManagerGlobal as PMG
from direct.showbase import PhysicsManagerGlobal as PMG2
from panda3d import physics
from direct.showutil import TexMemWatcher as TMW
    ...
    def enableParticles(self):
        if not self.particleMgrEnabled:
            ...
            if not self.physicsMgr:
                self.physicsMgr = PMG2.physicsMgr
